...
*/
var NameThatColor = /** @class */ (function () {
    function NameThatColor() {
        this.shades = [
            ["FF0000", "Red"],
            ["FFA500", "Orange"],
            ["FFFF00", "Yellow"],
    ...
    NameThatColor.prototype.init = function () {
        var color, rgb, hsl;
        for (var i = 0; i < this.names.length; i++) {
            color = "#" + this.names[i][0];
            rgb = NameThatColor_1.rgb(color);
            hsl = NameThatColor_1.hsl(color);
            this.names[i].push(rgb[0], rgb[1], rgb[2], hsl[0], hsl[1], hsl[2]);
        }
    };
    // adopted from: Farbtastic 1.2
    NameThatColor.prototype.name = function (color) {
        ...
        if (color.length == 4)
            color = "#" + color.substr(1, 1) +
                ...
                color.substr(3, 1) +
                color.substr(3, 1);
        var rgb = NameThatColor_1.rgb(color);
        var red = rgb[0];
        var green = rgb[1];
        var blue = rgb[2];
        var hsl = NameThatColor_1.hsl(color);
        var h = hsl[0];
        var s = hsl[1];
        var l = hsl[2];
        var cl = -1, df = -1;
        ...
        for (var i = 0; i < this.names.length; i++) {
            ...
            var ndf1 = Math.pow(red - this.names[i][3], 2) +
                Math.pow(green - this.names[i][4], 2) +
                Math.pow(blue - this.names[i][5], 2);
            var ndf2 = Math.abs(Math.pow(h - this.names[i][6], 2)) +
    ...
    NameThatColor.hsl = function (color) {
    ...
    ;
    NameThatColor = NameThatColor_1 = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [])
    ], NameThatColor);
    return NameThatColor;
    var NameThatColor_1;
}());
exports.NameThatColor = NameThatColor;
//# sourceMappingURL=NameThatColor.js.map